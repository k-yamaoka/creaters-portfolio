        ...
        <section>
          ...
          <ol className="mt-3 list-inside list-decimal space-y-2">
            ...
            <li>
              ...
              オンラインストレージ、電話、対面その他、当社が管理する記録として
            ...
            <li>
              「連絡が取りやすいから」等の理由で外部ツールへ移行することは、
              自身を守る手段を自ら手放す行為であることをユーザーは理解し、
              同意するものとします。
            </li>
          </ol>
        </section>

        {/* §10 双方の行動原則 (2026-07-21 追記) */}
        <section>
          <h2 className="text-lg font-bold text-[#222]">
            第6条の5（トラブル発生時の行動原則）
          </h2>
          <p className="mt-3">
            クリエイター・発注者の双方は、取引に関するトラブルが発生した際、
            以下の原則に従って行動するものとします。
          </p>
          <ol className="mt-3 list-inside list-decimal space-y-2">
            <li>
              <b>感情的な評価や報復的な低評価を行わない</b>。
              事実に基づかない、または報復目的の評価は、当社の判断により
              削除または非公開とすることがあります。
            </li>
            <li>
            ...
            <li>
              上記の手順を飛ばした行動 (例: 催促を送らずに直接運営裁定を申請する、
              事実確認をせず一方的に低評価を付ける等) は、
              <b>運営裁定において不利に扱われる場合</b>があります。
              手順を踏んでいることが、当事者間の合理的努力の証跡となります。
            </li>
          </ol>
        </section>
