          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-card sm:p-8">
            <div className="flex items-start justify-between gap-4">
              ...
              {(job.budget_min || job.budget_max) && (
                <div className="shrink-0 whitespace-nowrap text-right">
                  ...
                  <p className="text-xl font-bold text-aimovie-navy-900">
                    {job.budget_min &&
                    job.budget_max &&
                    job.budget_min === job.budget_max
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {(job.genres ?? []).map((genre: string) => (
                <span
                  key={genre}
                  className="rounded-pill bg-aimovie-navy-700/10 px-3 py-1 text-xs font-bold text-aimovie-navy-900"
                >
                  {genre}
                </span>
              ))}
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-card sm:p-8">
              {hasApplied ? (
                <div>
                  ...
                  {/* 応募済み = メッセージ解放 (#6) */}
                  <div className="mt-6 rounded-xl border border-aimovie-navy-700/20 bg-aimovie-navy-700/10 p-4">
                    <div className="flex items-start gap-3">
                      <svg className="mt-0.5 h-5 w-5 shrink-0 text-aimovie-navy-900" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          ...
          <div className="sticky top-24">
            <div className="grid grid-cols-[1fr,auto] divide-x divide-gray-200 rounded-2xl border border-gray-200 bg-white shadow-card">
              ...
              <div className="flex w-32 flex-col items-center justify-center p-5 text-center">
                ...
                <p className="mt-2 text-3xl font-black text-aimovie-navy-900">
