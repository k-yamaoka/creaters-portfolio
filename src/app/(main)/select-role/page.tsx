        ...
        <div className="rounded-2xl bg-white p-8 shadow-card">
          <div className="mb-2 text-center">
            <Link href="/" className="inline-flex items-center gap-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-r from-aimovie-navy-900 to-aimovie-ember-500 text-sm font-black text-white">
                A
              </div>
