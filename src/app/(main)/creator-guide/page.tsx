      ...
      <div className="mt-10 space-y-10">
        ...
        <section className="rounded-2xl bg-white p-6 shadow-card sm:p-8">
          ...
          <ul className="mt-4 space-y-3">
            {[
              "正確な情報を記載してください（スキル・対応ジャンル・実績など）",
              "プロフィール写真は本人の顔写真またはロゴを推奨します",
              "得意ジャンル・制作実績・対応尺など、制作の方向性が伝わる情報を明記してください",
              "虚偽の情報や誇大な表現は禁止です",
            ].map((t) => (
        ...
        <section className="rounded-2xl bg-white p-6 shadow-card sm:p-8">
          ...
          <ul className="mt-4 space-y-3">
            {[
              "最低受注金額は対応可能な「最小スコープ」(本数 / 尺 / 工程) を踏まえて設定してください",
              "追加プロンプト調整や追加本数など、追加料金が発生する場合は事前にクライアントへ説明してください",
        ...
        <section className="rounded-2xl bg-white p-6 shadow-card sm:p-8">
          ...
          <ul className="mt-4 space-y-3">
            {[
              ...
              "修正依頼には事前合意の修正回数の範囲内で誠実に対応してください",
