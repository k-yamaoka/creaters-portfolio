...
('cl000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '株式会社テックサンプル', 'https://example.com', 'IT・通信'),
('cl000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', '株式会社メディアクリエイト', 'https://example.com', 'メディア・エンタメ'),
('cl000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000003', '合同会社フードデリバリー', 'https://example.com', '飲食・サービス')
ON CONFLICT (user_id) DO NOTHING;

INSERT INTO jobs (client_id, title, description, genres, budget_min, budget_max, deadline, delivery_deadline, status) VALUES
('cl000000-0000-0000-0000-000000000001', '新サービスのプロモーション動画制作',
...
('cl000000-0000-0000-0000-000000000002', 'YouTube企業チャンネルの動画編集者募集（継続案件）',
...
('cl000000-0000-0000-0000-000000000003', 'Instagram/TikTok向け飲食店プロモーション動画',
